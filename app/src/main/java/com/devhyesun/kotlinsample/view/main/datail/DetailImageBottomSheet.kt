package com.devhyesun.kotlinsample.view.main.datail
...
class DetailImageBottomSheet : BottomSheetDialogFragment(), DetailImageContract.View {
    ...
    private val detailImagePresenter by lazy {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View = View.inflate(context, R.layout.layout_photo_detail, null)
